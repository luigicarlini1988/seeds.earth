...
<html lang="en" dir="ltr">
  <head>
    ...
    <!--luigi's includer php sections on specific window size-->
    <script src="js/selective-includer.js" type="text/javascript"></script>
                                              ...
                                              <div class="field-body">
                                                  <div class="field">
                                                      <div class="control required">
                                                          ...
                                                          <input class="input is-large" name="org_name" type="text" placeholder="Lorem Ipsum" value="" data-validate="require">
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                              ...
                                              <div class="field-body">
                                                  <div class="field">
                                                      <div class="control required">
                                                        ...
                                                        <input class="input is-large" name="amount"  ype="number" min="0" value="1" data-validate="require">
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                            ...
                                            <div class="field-body">
                                                <div class="field">
                                                    <div class="control required">
                                                        ...
                                                        <input class="input is-large" name="email" type="text" placeholder="Lorem Ipsum" value="" data-validate="require">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="field-body">
                                                <div class="field">
                                                    <div class="control required">
                                                        ...
                                                        <input class="input is-large" name="product_image" type="text" placeholder="Lorem Ipsum" value="" data-validate="require">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="field-body">
                                                <div class="field">
                                                    <div class="control required">
                                                        ...
                                                        <input class="input is-large" name="product_name" type="text" placeholder="Lorem Ipsum" value="" data-validate="require">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="field-body">
                                                <div class="field">
                                                    <div class="control required">
                                                        ...
                                                        <input class="input is-large" name="product_description" type="text" placeholder="Lorem Ipsum" value="" data-validate="require">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="field-body">
                                                <div class="field">
                                                    <div class="control required">
                                                        ...
                                                        <input class="input is-large" name="callback" type="text" placeholder="Lorem Ipsum" value="" data-validate="require">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
