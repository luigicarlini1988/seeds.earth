        ...
        <section class="buy-header parallax" data-image-src="img/buy-header.jpg">
            <div class="centered">
                <div class="buy-intro close">
                    ...
                    <p>By creating the Join SEEDS widget on your website, you’ll be able to bring your community onto
                        the SEEDS platform and start sharing Seeds currency from your live campaigns immediately.</p>
                            ...
                            <div class="steps-wrapper">
                                ...
                                <div class="steps">
                                    ...
                                    <div class="steps-content">
                                        <!-- STEP CONTENT 1 -->
                                        <div data-step-id="1" id="step-1"
                                            class="step-content has-text-centered is-active animated preFadeInUp fadeInUp">
                                            ...
                                            <div class="text-content">
                                                <div class=" has-text-centered">
                                                    <p>Start verifying your organisation account name in the form below.
                                                        <br> After the verification, simply add you Campaign name and
                                                        choose the colour theme that works best with your website and
                                                        generate the code! <br><br>Now, simply paste the widget code
                                                        onto your website wherever you want the join SEEDS button to
                                                        appear.</p>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="field-body">
                                                            <div class="field">
                                                                <div class="control required">
                                                                    <label for="org_id" class="label">Organisation
                                                                        Account Name</label>
                                                                    <input id="org-id" class="input is-large"
                                                                        name="org_id" type="text"
                                                                        placeholder="Insert here..." value=""
                                                                        data-validate="require">
                                                                    <p class="helper">Enter the 12-character SEEDS
                                                                        account name you have created for your
                                                                        organisation.</p>
                                                ...
                                                <div class="wrap-shower">
                                                    ...
                                                    <div id="scroll-after-valid" class="actual-field">
                                                        <div class="field field-container">
                                                            <div class="field-body">
                                                                <div class="field">
                                                                    <div class="control required">
                                                                        <label for="campaign_name" class="label">Invite
                                                                            Campaign Name</label>
                                                                        <input id="campaign-name" class="input is-large"
                                                                            name="campaign_name" value="" type="text"
                                                                            placeholder="Insert here..."
                                                                            data-validate="require">
                                                                        <p class="helper">Enter the name of the Invite
                                                                            Campaign you created with your organisation
                                                                            account in the Global Passport.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="actual-field toggles">
                                                        <div class="field field-container">
                                                            <div class="field-body">
                                                                <div class="field">
                                                                    <div class="control required">
                                                                        <label for="button_theme" class="label">Button
                                                                            Style</label>
                                                                        <div class="radios">
                                                                            <div class="radios-button-style">
                                                                                <button type="button"
                                                                                    class="join-seeds-white"></button>
                                                                                <input class="input is-large"
                                                                                    name="button_theme" type="radio"
                                                                                    value="white" checked
                                                                                    data-validate="require">
                                                                            </div>
                                                                            <div class="radios-button-style">
                                                                                <button type="button"
                                                                                    class="join-seeds-light"></button>
                                                                                <input class="input is-large"
                                                                                    name="button_theme" type="radio"
                                                                                    value="light"
                                                                                    data-validate="require">
                                                        ...
                                                        <div class="field field-container">
                                                            <div class="field-body">
                                                                <div class="field">
                                                                    <div class="control required">
                                                                        <label class="label"
                                                                            for="multistep_theme">Multistep
                                                                            Style</label>
                                                                        <div class="radios">
                                                                            <div class="radios-button-style">
                                                                                <div class="joinseeds-theme-dark"></div>
                                                                                <input class="input is-large"
                                                                                    name="multistep_theme" value="dark"
                                                                                    checked type="radio"
                                                                                    data-validate="require">
                                                                            </div>
                                                                            <div class="radios-button-style">
                                                                                <div class="joinseeds-theme-light">
                                                                                </div>
                                                                                <input class="input is-large"
                                                                                    name="multistep_theme" value="light"
                                                                                    type="radio"
                                                                                    data-validate="require">
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <div class="wrap-real-widget">
                                                        ...
                                                        <div class="actual-field">
                                                                    ...
                                                                    <div class="field">
                                                                        <div class="control required">
                                                                            ...
                                                                            <textarea id="code-output"
                                                                                class="input is-large" name="code"
                                                                                rows="10" placeholder=""
                                                            ...
                                                            <div class="flexier">
                                                                <p id="real-widget-clear">Edit Widget</p>
                                                                <p id="real-widget-copy">Copy Code</p>
                                                            </div>
