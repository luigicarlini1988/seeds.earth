...
<body class="get-started-page">
    ...
    <main>
        ...
        <div class="ui-slide">
            <ul>
                <li data-slide-link="0" class="active">
                    <p>0</p>
                </li>
                <li data-slide-link="1" class="list-2">
                    <p>1</p>
                </li>
                <li data-slide-link="2" class="list-3">
                    <p>2</p>
                </li>
                <li data-slide-link="3" class="list-4">
                    <p>3</p>
                </li>
            </ul>
        </div>
        ...
        <div class="gs snap-container">
            ...
            <div class="slide-gs" id="slide-gs-1">
                ...
                <div class="content">
                    <div class="text-content">
                        ...
                        <p>Wherever you are, it’s the perfect place to begin. <br>Luckily, it only takes 3 steps to
                            begin this journey and start co-creating this new world with us. </p>
            ...
            <div class="slide-gs" id="slide-gs-2">
                <div class="content">
                    <div class="text-content">
                        <h2>Download the<br /><span class="spring">Light Wallet</h2>
                        <p>The Light Wallet app is your point of access into the SEEDS financial ecosystem.</p>
                        <ul class="bp">
                        ...
                        <div class="buttons-store end">
                            <div class="apple"><a class="ju spri"
                                    ...
                                    target="_blank"><img src="img/apple-dark.svg">Apple Store</a></div>
                            <div class="android"><a class="ju spri"
                                    ...
                                    target="_blank"><img src="img/android-dark.svg">Play Store</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="slide-cont">
                    <div class="slide-passport-1">
                        <img class="passport-sc-1" src="img/light-wallet/light-1.jpg" />
                    </div>
                    <div class="slide-passport-2">
                        <img class="passport-sc-2" src="img/light-wallet/light-2.jpg" />
                    </div>
                </div>
                ...
                <div class="other-numb">
                    <p class="on">01</p>
                    <p class="vertical">SEEDS Light <span class="spring">Wallet</span></p>
                </div>
            </div>
            ...
            <div class="slide-gs" id="slide-gs-3">
                <div class="content">
                    <div class="text-content">
                        ...
                        <p>While everyone is invited to the party, we just want to make sure you’re a sentient creature
                            and not a robot. That’s why we implemented the Web of Trust by asking people to request an
                            invitation.<span class="spring"> You can do this directly in the Light Wallet.</span></p>
                ...
                <div class="slide-cont">
                    <div class="slide-passport-3">
                        <img class="passport-sc-3" src="img/light-wallet/light-3.jpg" />
                    </div>
            ...
            <div class="slide-gs" id="slide-gs-4">
                ...
                <div class="content">
                    <div class="text-content">
                        ...
                        <p>That’s it! You’re in! Get ready to play! There’s a whole community here to help you on this
                            journey.</p>
                        <div class="buttons-store end">
                            <div class="apple"><a class="ju spri"
                                    href="https://apps.apple.com/us/app/seeds-light-wallet/id1507143650"
