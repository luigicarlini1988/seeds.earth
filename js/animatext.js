      ...
      animaText = function(element) {
            ...
            $(cutParagraphs).each(function(i, item) {
              ...
              if (settings.mode === "chars") {
                ...
                $(cutWord).each(function(i, item) {
                  return chars += '<span class="char' + (i + 1) + '" aria-hidden="true" style="opacity:0; top:40px; display:inline-block">' + item + '</span>';
                });
                return words += '<span class="word' + (i + 1) + '" aria-hidden="true" aria-label="' + item + '" style="display:inline-block">' + chars + '</span> ';
              } else {
                return words += '<span class="word' + (i + 1) + '" aria-hidden="true" style="opacity:0; top:40px; display:inline-block">' + item + '</span> ';
              }
            });
        ...
        relaunchAnimation = function(element) {
          if (settings.group) {
            ...
            element.find("span").css({'opacity' : '0', 'top' : '40px'});
