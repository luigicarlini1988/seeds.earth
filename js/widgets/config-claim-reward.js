var form = document.getElementById('claim-reward-form');
var code_input = form.querySelector('textarea[name="code"]');
var widget = null;

function getCode() {
	var code = "<div id=\"claim-reward-seeds\"></div>\n";
	code += "<script src=\"https://seeds-cdn.s3.amazonaws.com/js/claimreward.js\"></script>\n";
	code += "<script>\n\tnew ClaimRewardSeed(\"claim-reward-seeds\", " + JSON.stringify(getConfig()) + " );\n</script>\n";
