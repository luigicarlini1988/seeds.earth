...
<html lang="en" dir="ltr">
  <head>
    ...
    if (typeof MauticSDKLoaded == 'undefined') {
        ...
        script.type         = 'text/javascript';
        script.src          = 'https://campaigns.hypha.earth/media/js/mautic-form.js';
        script.onload       = function() {
            MauticSDK.onLoad();
        };
        head.appendChild(script);
        var MauticDomain = 'https://campaigns.hypha.earth';
        var MauticLang   = {
  ...
  <body class="home-nu">
    ...
    <div class="pop-up">
      ...
      <div class="centered">
        ...
        <div id="mauticform_wrapper_subscribeformjonseedsearth" class="mauticform_wrapper">
            <form autocomplete="false" role="form" method="post" action="https://campaigns.hypha.earth/form/submit?formId=5" id="mauticform_subscribeformjonseedsearth" data-mautic-form="subscribeformjonseedsearth" enctype="multipart/form-data">
                <div class="mauticform-error" id="mauticform_subscribeformjonseedsearth_error"></div>
                <div class="mauticform-message" id="mauticform_subscribeformjonseedsearth_message"></div>
                <div class="mauticform-innerform">


                  <div class="mauticform-page-wrapper mauticform-page-1" data-mautic-form-page="1">

                    <div id="mauticform_subscribeformjonseedsearth_email" data-validate="email" data-validation-type="email" class="mauticform-row mauticform-email mauticform-field-1 mauticform-required">
                        <label id="mauticform_label_subscribeformjonseedsearth_email" for="mauticform_input_subscribeformjonseedsearth_email" class="mauticform-label">Email</label>
                        <input id="mauticform_input_subscribeformjonseedsearth_email" name="mauticform[email]" value="" class="mauticform-input" type="email">
                        <span class="mauticform-errormsg" style="display: none;">Email Field required</span>
                    </div>

                    <div id="mauticform_subscribeformjonseedsearth_first_name" data-validate="first_name" data-validation-type="text" class="mauticform-row mauticform-text mauticform-field-2 mauticform-required">
                        <label id="mauticform_label_subscribeformjonseedsearth_first_name" for="mauticform_input_subscribeformjonseedsearth_first_name" class="mauticform-label">First Name</label>
                        <input id="mauticform_input_subscribeformjonseedsearth_first_name" name="mauticform[first_name]" value="" class="mauticform-input" type="text">
                        <span class="mauticform-errormsg" style="display: none;">First name required</span>
                    </div>

                    <div id="mauticform_subscribeformjonseedsearth_last_name" class="mauticform-row mauticform-text mauticform-field-3">
                        <label id="mauticform_label_subscribeformjonseedsearth_last_name" for="mauticform_input_subscribeformjonseedsearth_last_name" class="mauticform-label">Last Name</label>
                        <input id="mauticform_input_subscribeformjonseedsearth_last_name" name="mauticform[last_name]" value="" class="mauticform-input" type="text">
                        <span class="mauticform-errormsg" style="display: none;"></span>
                    </div>

                    <div id="mauticform_subscribeformjonseedsearth_country" class="mauticform-row mauticform-text mauticform-field-4">
                        <label id="mauticform_label_subscribeformjonseedsearth_country" for="mauticform_input_subscribeformjonseedsearth_country" class="mauticform-label">Country</label>
                        <input id="mauticform_input_subscribeformjonseedsearth_country" name="mauticform[country]" value="" class="mauticform-input" type="text">
                        <span class="mauticform-errormsg" style="display: none;"></span>
                    </div>

                    <div id="mauticform_subscribeformjonseedsearth_submit" class="mauticform-row mauticform-button-wrapper mauticform-field-5">
                        <button type="submit" name="mauticform[submit]" id="mauticform_input_subscribeformjonseedsearth_submit" value="" class="mauticform-button btn btn-default">Submit</button>
                    </div>
                    </div>
                </div>

                <input type="hidden" name="mauticform[formId]" id="mauticform_subscribeformjonseedsearth_id" value="5">
                <input type="hidden" name="mauticform[return]" id="mauticform_subscribeformjonseedsearth_return" value="">
                <input type="hidden" name="mauticform[formName]" id="mauticform_subscribeformjonseedsearth_name" value="subscribeformjonseedsearth">
            ...
            <div class="hh-left">
              ...
              <div class="cta-header">
                ...
                <div id="nl-sign-up-resp">
                  <p class="nl-s spri" href="get-started.php"><img src="img/nl-icon.svg" />Newsletter Sing-up</p>
                </div>
              </div>
