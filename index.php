...
<head>
    ...
    <meta name="description"
        content="A new economy that rewards regenerative behaviours, finances the regeneration of our Earth and encourages collaboration and community building">
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                var citizen = result.filter(function(r) {
                    return r._id === 'citizen';
                })[0].total;
                $("#append0").append(citizen);

                var resident = result.filter(function(r) {
                    return r._id === 'resident';
                })[0].total;
                $("#append1").append(resident);

                var visitor = result.filter(function(r) {
                    return r._id === 'visitor';
                })[0].total;
...
<body class="home-nu">
   ...
   <div class="pop-up">
      ...
      <div class="centered">
        ...
        <div id="mauticform_wrapper_formsubscribe2joinseedsearth" class="mauticform_wrapper">
            <form autocomplete="false" role="form" method="post" action="https://newsletters.hypha.earth/form/submit?formId=1" id="mauticform_formsubscribe2joinseedsearth" data-mautic-form="formsubscribe2joinseedsearth" enctype="multipart/form-data" name="Form-Subscribe2JoinSeedsEarth">
                <div class="mauticform-error" id="mauticform_formsubscribe2joinseedsearth_error"></div>
                <div class="mauticform-message" id="mauticform_formsubscribe2joinseedsearth_message"></div>
                <div class="mauticform-innerform">


                  <div class="mauticform-page-wrapper mauticform-page-1" data-mautic-form-page="1">

                    <div id="mauticform_formsubscribe2joinseedsearth_email" data-validate="email" data-validation-type="email" class="mauticform-row mauticform-email mauticform-field-1 mauticform-required">
                        <label id="mauticform_label_formsubscribe2joinseedsearth_email" for="mauticform_input_formsubscribe2joinseedsearth_email" class="mauticform-label">Email</label>
                        <input id="mauticform_input_formsubscribe2joinseedsearth_email" name="mauticform[email]" value="" class="mauticform-input" type="email">
                        <span class="mauticform-errormsg" style="display: none;">this field is mandatory</span>
                    </div>

                    <div id="mauticform_formsubscribe2joinseedsearth_first_name" data-validate="first_name" data-validation-type="text" class="mauticform-row mauticform-text mauticform-field-2 mauticform-required">
                        <label id="mauticform_label_formsubscribe2joinseedsearth_first_name" for="mauticform_input_formsubscribe2joinseedsearth_first_name" class="mauticform-label">First Name</label>
                        <input id="mauticform_input_formsubscribe2joinseedsearth_first_name" name="mauticform[first_name]" value="" class="mauticform-input" type="text">
                        <span class="mauticform-errormsg" style="display: none;">this field is mandatory</span>
                    </div>

                    <div id="mauticform_formsubscribe2joinseedsearth_last_name" data-validate="last_name" data-validation-type="text" class="mauticform-row mauticform-text mauticform-field-3 mauticform-required">
                        <label id="mauticform_label_formsubscribe2joinseedsearth_last_name" for="mauticform_input_formsubscribe2joinseedsearth_last_name" class="mauticform-label">Last Name</label>
                        <input id="mauticform_input_formsubscribe2joinseedsearth_last_name" name="mauticform[last_name]" value="" class="mauticform-input" type="text">
                        <span class="mauticform-errormsg" style="display: none;">this field is mandatory</span>
                    </div>

                    <div id="mauticform_formsubscribe2joinseedsearth_country" data-validate="country" data-validation-type="country" class="mauticform-row mauticform-select mauticform-field-4 mauticform-required">
                        <label id="mauticform_label_formsubscribe2joinseedsearth_country" for="mauticform_input_formsubscribe2joinseedsearth_country" class="mauticform-label">Country</label>
                        <select id="mauticform_input_formsubscribe2joinseedsearth_country" name="mauticform[country]" value="" placeholder="Unknown" class="mauticform-selectbox">
                    ...
                    <div id="mauticform_formsubscribe2joinseedsearth_captcha" style="display: none;" class="mauticform-row mauticform-text mauticform-field-5">
                        <label id="mauticform_label_formsubscribe2joinseedsearth_captcha" for="mauticform_input_formsubscribe2joinseedsearth_captcha" class="mauticform-label">I'm Not a Robot</label>
                        <input id="mauticform_input_formsubscribe2joinseedsearth_captcha" name="mauticform[captcha]" value="" class="mauticform-input" type="text">
                        <span class="mauticform-errormsg" style="display: none;"></span>
                    </div>

                    <div id="mauticform_formsubscribe2joinseedsearth_submit" class="mauticform-row mauticform-button-wrapper mauticform-field-6">
                        <button type="submit" name="mauticform[submit]" id="mauticform_input_formsubscribe2joinseedsearth_submit" value="" class="mauticform-button btn btn-default">Submit</button>
                    </div>
                    </div>
                </div>

                <input type="hidden" name="mauticform[formId]" id="mauticform_formsubscribe2joinseedsearth_id" value="1">
                <input type="hidden" name="mauticform[return]" id="mauticform_formsubscribe2joinseedsearth_return" value="">
                <input type="hidden" name="mauticform[formName]" id="mauticform_formsubscribe2joinseedsearth_name" value="formsubscribe2joinseedsearth">
    ...
    <main>
            ...
            <div class="centered">
                <div class="hh-left">
                    ...
                    <div class="text-anim">
                        ...
                        <div class="ta-bottom">
                            ...
                            <div class="ta-b-text close">
                                <p class="d-only">Seeds is a currency that aligns money with value. <br> We value
                                    people, planet and prosperity for all.</p>
                                <p class="r-only">Seeds is a currency that aligns money with value. We value people,
                                    planet and prosperity for all.</p>
                            </div>
                        </div>
                    ...
                    <div class="cta-header">
                        <div class="apple"><a class="ju spri"
                                href="https://apps.apple.com/us/app/seeds-light-wallet/id1507143650"
                                target="_blank"><img src="img/apple.svg">Apple Store</a></div>
                        <div class="android"><a class="ju spri"
                                href="https://play.google.com/store/apps/details?id=com.joinseeds.seedswallet&hl=en_US&gl=US&pli=1"
                                target="_blank"><img src="img/google.svg">Play Store</a></div>
                        <div class="get-cta-h">
                            <a class="ju spri" href="get-started.php"><img src="img/plus-green.svg" />Get Started</a>
                        </div>

                        <div id="nl-sign-up-resp">
                            <a href="newsletter-opt-in" class="nl-s spri" href="newsletter-opt-in.php"><img
                                    src="img/nl-icon.svg" />Newsletter Sign-up</a>
                        </div>
                    </div>
                ...
                <div class="hh-right close">
                    ...
                    <div id="nl-sign-up">
                        <a class="nl-s spri" href="newsletter-opt-in.php"><img src="img/nl-icon.svg" />Newsletter
                            Sign-up</a>
                    </div>
            ...
            <div class="centered">
                ...
                <div class="what-left">
                    <div class="video-what-is-seeds">
                        <iframe width="100%" height="auto" src="https://www.youtube.com/embed/WXWBSffxT88"
                            frameborder="0" allow="gyroscope; picture-in-picture;" allowfullscreen></iframe>
                ...
                <div class="what-right close">
                    <div class="c-text lax" data-lax-translate-y="(vh) 1, (-vh) -200" data-lax-anchor="self">
                        <p class="special">We came together to<br><span class="spring">co-create a new economic
                                system.</span></p>
                        <p>SEEDS offers tools to help you, your business and your movement regenerate our planet and
                            encourage collaboration, cooperation and community building. We are changing the way we
                            <span class="spring">assign and distribute value.</span>
                        </p>
                    </div>
                </div>
        ...
        <section id="anch-ecosystem" class="eco-data">
            <div class="centered between">
                ...
                <div class="sub-tit-50">
                    <p class="special-28">Instead of being more profitable to exploit the natural world, we reward the
                        <span class="spring">regeneration of our planet. </span>
                    </p>
                </div>

                <div class="sub-tit-50">
                    <p style="margin-top:0;">Using algorithms within the SEEDS platforms, we incentivise collaborative
                        and regenerative behaviours and activities for the wellbeing of the whole. </p>
                </div>
            </div>
            ...
            <div class="centered lax" data-lax-translate-y="(vh) 1, (-vh) -200" data-lax-anchor="self">
                ...
                <div class="col">
                    ...
                    <p>Using the Light Wallet app, we have <span id="append0"></span> Citizens, <span
                            id="append1"></span> Residents and <span id="append2"></span> Visitors.</p>
                    <div class="line"></div>
                </div>
                ...
                <div class="col">
                    ...
                    <p>Over 450 partner organisations signed up and over 55 projects (campaigns and alliances) have been
                        funded.</p>
                    <div class="line"></div>
                </div>
        ...
        <section id="anch-cta" class="cta">
            ...
            <div class="centered minus">
                ...
                <div class="cta-r">
                    <div class="cuut">
                        <div class="rag-0 lax" data-lax-rotate="(vh) 0, (-vh) 600 | speed=.2" data-lax-anchor="self">
                            <img class="rag" src="img/raggera.svg" />
                        </div>
                        <div class="rag-1 lax" data-lax-rotate="(vh) 0, (-vh) 500 | speed=.2" data-lax-anchor="self">
                            <img class="rag" src="img/raggera.svg" />
                        </div>
                        <div class="rag-2 lax" data-lax-rotate="(vh) 0, (-vh) 400 | speed=.2" data-lax-anchor="self">
                            <img class="rag" src="img/raggera.svg" />
                        </div>
                        <div class="rag-3 lax" data-lax-rotate="(vh) 0, (-vh) 300 | speed=.2" data-lax-anchor="self">
                            <img class="rag" src="img/raggera.svg" />
                        </div>
                        <div class="rag-4 lax" data-lax-rotate="(vh) 0, (-vh) 200 | speed=.2" data-lax-anchor="self">
                            <img class="rag" src="img/raggera.svg" />
                        </div>
        ...
        <section id="anch-tools" class="tools-offered">
            <div class="centered">
                ...
                <div class="c-tit">
                    <div class="sub-tit-50">
                        <p class="special-42">Tools for the people, <br /><span class="spring"> planet and prosperity to
                                thrive</spring>
                        </p>
                    </div>
                </div>
                ...
                <div class="sub-tit-50">
                    ...
                    <p>SEEDS offers you <span class="spring">several apps</span> and <span class="spring">
                            plug-ins</span> to help you through this new economic system in your life. And, the entire
                        SEEDS community is here to guide you through this journey.</p>
                </div>

                <div class="sub-tit-50">

                    <p>On these platforms we use <span class="spring"><img class="small-cur"
                                src="img/seeds-currency.png" /> Seeds, a currency with a conscience.</span> This
                        currency is designed for your everyday use, all while changing the world through shared purpose
                        and incentives.</p>
                ...
                <div class="org-h-left">
                    <div class="ohl-wrap">
                        <div class="c-cont close">
                            ...
                            <p>Find all the tools you need to <strong>invite</strong> your members to join, send them
                                <strong>rewards</strong> and <strong>accept payments</strong> in Seeds on your website.
                            </p>
            ...
            <div class="centered">
                <div class="cs-left">
                    <div class="c-cont close">
                        ...
                        <div class="c-text">
                            <p>Find out how people and organisations are utilising the SEEDS tools for their own
                                regenerative efforts to make the world better for all of us.</p>
                        </div>
                        <div class="col-read">
                            <a class="ju" href="https://joinseeds.earth/become-an-alliance" target="blank"><img
                                    src="img/plus.svg" />Become an Alliance Partner</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="cs-right">
                    ...
                    <div class="col-half">
                        ...
                        <article>
                            ...
                            <div class="art-tit">
                                <h3> <a href="https://seedslibrary.com/money-that-grows-trees/" target="_blank">Money
                                        that grows trees</a> </h3>
                            </div>
                        </article>
                    ...
                    <div class="col-half">
                        <article>
                            ...
                            <div class="thumb">
                                <a href="https://seedslibrary.com/seeds-help-to-complete-finca-sagrada-dream/"
                                    target="_blank">
                                    <img src="img/articles/finca-sagrada-garden.jpg" />
                                </a>
                            </div>
                            <div class="art-tit">
                                <h3> <a href="https://seedslibrary.com/seeds-help-to-complete-finca-sagrada-dream/"
                                        target="_blank">SEEDS Help to Complete Finca-Sagrada Dream</a> </h3>
                            </div>
                    ...
                    <div class="col-half">
                        <article>
                            ...
                            <div class="thumb">
                                <a href="https://seedslibrary.com/telos-blockchain-for-farmers-explained/"
                                    target="_blank">
                                    <img src="img/articles/blockchain-for-farmers.jpg" />
                                </a>
                            </div>
                            <div class="art-tit">
                                <h3> <a href="https://seedslibrary.com/telos-blockchain-for-farmers-explained/"
                                        target="_blank">Telos Blockchain for Farmers Explained</a> </h3>
                            </div>
                    ...
                    <div class="col-half">
                        <article>
                            ...
                            <div class="thumb">
                                <a href="https://seedslibrary.com/moct-a-movement-for-uplifting-communities/"
                                    target="_blank">
                                    <img src="img/articles/save-families.jpg" />
                                </a>
                            </div>
                            <div class="art-tit">
                                <h3> <a href="https://seedslibrary.com/moct-a-movement-for-uplifting-communities/"
                                        target="_blank">A Movement to Save Families</a> </h3>
                            </div>
                    ...
                    <div class="col-half">
                        <article>
                            ...
                            <div class="thumb">
                                <a href="https://seedslibrary.com/better-than-free-school-for-regen-practices/"
                                    target="_blank">
                                    <img src="img/articles/school-for-regen-practice.jpg" />
                                </a>
                            </div>
                            <div class="art-tit">
                                <h3> <a href="https://seedslibrary.com/better-than-free-school-for-regen-practices/"
                                        target="_blank">Better-Than-Free School for Regen Practices</a> </h3>
                            </div>
                    ...
                    <div class="col-half">
                        <article>
                            ...
                            <div class="art-tit">
                                <h3> <a href="https://seedslibrary.com/growing-a-growers-movement-in-india/"
                                        target="_blank">Growing a Growers Movement in India</a> </h3>
                            </div>
                    ...
                    <div class="col-half">
                        <article>
                            ...
                            <div class="thumb">
                                <a href="https://seedslibrary.com/seeding-bioregional-well-being-economies/"
                                    target="_blank">
                                    <img src="img/articles/seeding-bioregional-economies.jpg" />
                                </a>
                            </div>
                            <div class="art-tit">
                                <h3> <a href="https://seedslibrary.com/seeding-bioregional-well-being-economies/"
                                        target="_blank">Seeding Bioregional Well-Being Economies</a> </h3>
                            </div>
                    ...
                    <div class="col-half">
                        <article>
                            ...
                            <div class="art-tit">
                                <h3> <a href="https://seedslibrary.com/embracing-the-many-voices-of-seeds/"
                                        target="_blank">Embracing the Many Voices of SEEDS</a> </h3>
                            </div>
            ...
            <div class="centered only-resp">
                <div class="cs-left">
                    <div class="c-cont close">
                        ...
                        <div class="c-text">
                            <p>Everything from blockchain technology to application software, SEEDS takes advantage of
                                all the most innovative technologies to make this new world possible.</p>
                        </div>
                        <div class="col-read">
                ...
                <div class="owl-carousel">
                    <div class="card">
                        <div class="c-cont close">
                            ...
                            <div class="c-text">
                                <p>Everything from blockchain technology to application software, SEEDS takes advantage
                                    of all the most innovative technologies to make this new world possible.</p>
                            </div>
                            <div class="col-read">
                                <a class="ju" href="https://seedslibrary.com/" target="_blank"><img
                                        src="img/plus.svg" />Discover the SEEDS library</a>
                                <a class="ju" href="#" target="_blank"><img src="img/plus.svg" />Co-create the Living
                                    Constitution</a>
                                <a class="ju" href="#" target="_blank"><img src="img/plus.svg" />Play with SEEDS Game
                                    Guide</a>
                            </div>
                    ...
                    <div class="card">
                        <article>
                            ...
                            <div class="thumb">
                                <a href="https://seedslibrary.com/blockchain-as-a-single-source-of-truth/"
                                    target="blank">
                                    <img src="img/articles/blockchain-single-truth.jpg" />
                                </a>
                            </div>
                            <div class="art-tit">
                                <h3> <a href="https://seedslibrary.com/blockchain-as-a-single-source-of-truth/"
                                        target="blank">Blockchain as a Single Source of Truth</a> </h3>
                            </div>
                    ...
                    <div class="card">
                        <article>
                            ...
                            <div class="art-tit">
                                <h3> <a href="https://seedslibrary.com/seeds-cryptocurrency-explained/"
                                        target="blank">Seeds Cryptocurrency Explained</a> </h3>
                            </div>
                    ...
                    <div class="card">
                        <article>
                            ...
                            <div class="thumb">
                                <a href="https://seedslibrary.com/cryptocurrency-a-solution-to-our-environmental-crisis/"
                                    target="blank">
                                    <img src="img/articles/environmental-crisis-solution.jpg" />
                                </a>
                            </div>
                            <div class="art-tit">
                                <h3> <a href="https://seedslibrary.com/cryptocurrency-a-solution-to-our-environmental-crisis/"
                                        target="blank">Cryptocurrency: Our Environmental Crisis Solution</a> </h3>
                            </div>
                    ...
                    <div class="card">
                        <article>
                            ...
                            <div class="art-tit">
                                <h3> <a href="https://seedslibrary.com/why-you-want-to-accept-seeds/"
                                        target="_blank">Why You Want to Accept Seeds</a> </h3>
                            </div>
                        </article>
                    </div>
                    ...
                    <div class="card">
                        <article>
                            ...
                            <div class="art-tit">
                                <h3> <a href="https://seedslibrary.com/seeds-harvest-in-action/" target="_blank">Seeds
                                        Harvest in Action</a> </h3>
                            </div>
                        </article>
                    </div>
            ...
            <div class="centered">
                <div class="cs-left">
                    <div class="c-cont close">
                        ...
                        <div class="c-text">
                            <p>Get an idea of the major milestones we’ve identified to earmark the development of our
                                economy.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="cs-right">
                    ...
                    <div class="col-half">
                        <div class="time-card close">
                            ...
                            <p class="tc-cont">The foundations for the “Minimum Viable Society” are released to the
                                world.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-half">
                        <div class="time-card close">
                            ...
                            <p class="tc-cont">The Citizens begin voting on a wide diversity of campaigns to finance the
                                regenerative renaissance. From planting trees to doing good deeds and anything in
                                between.</p>
                        </div>
                    </div>
                  ...
                  <p class="tc-cont">Public release and update of the SEEDS Global Passport on app stores.</p>
                    ...
                    <div class="col-half">
                        <div class="time-card close">
                            ...
                            <p class="tc-cont">The Citizens begin voting on a wide diversity of Alliances from
                                organisations to be gifted Seeds based on their dedication to creating a regenerative
                                civilization and supporting this Regenerative Renaissance!</p>
                        </div>
                    </div>
                  ...
                  <p class="tc-cont">The SEEDS community celebrates its one year birthday with a global live online event.</p>
                    ...
                    <div class="col-half">
                        <div class="time-card close">
                            ...
                            <p class="tc-cont">Major release and update of the SEEDS Passport! SEEDS has a new look and
                                a much easier interface to engage with its tools.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-half">
                        <div class="time-card close">
                            ...
                            <p class="tc-cont">All major features the Citizens need to govern, evolve, model, exchange
                                and grow their own financial system are deployed. Final economic and security tests
                                running.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-half">
                        <div class="time-card close">
                            ...
                            <p class="tc-cont">Go Live" occurs when Citizens vote on whether or not they believe the
                                SEEDS economy is robust enough to start stabilising the value of the Seeds currency and
                                start the "Harvest". We want this point to occur when our economy is large enough that
                                we can start meeting our needs using Seeds. This event won't occur until the price of
                                Seeds is at least $0.80 USD.</p>
                        </div>
                    </div>
