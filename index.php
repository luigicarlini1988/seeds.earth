    ...
    <div class="pop-up">
      ...
      <div class="centered">
        ...
        <div id="mauticform_wrapper_subscribeformjoinseedsearth" class="mauticform_wrapper">
            <form autocomplete="false" role="form" method="post" action="https://campaigns.hypha.earth/form/submit?formId=5" id="mauticform_subscribeformjoinseedsearth" data-mautic-form="subscribeformjoinseedsearth" enctype="multipart/form-data">
                ...
                <div class="mauticform-innerform">
                  ...
                  <div class="mauticform-page-wrapper mauticform-page-1" data-mautic-form-page="1">
                    ...
                    <div id="mauticform_subscribeformjoinseedsearth_last_name" class="mauticform-row mauticform-text mauticform-field-3">
                    ...
                    <div id="mauticform_subscribeformjoinseedsearth_country1" data-validate="country1" data-validation-type="country" class="mauticform-row mauticform-select mauticform-field-4 mauticform-required">
                        <label id="mauticform_label_subscribeformjoinseedsearth_country1" for="mauticform_input_subscribeformjoinseedsearth_country1" class="mauticform-label">Country</label>
                        <select id="mauticform_input_subscribeformjoinseedsearth_country1" name="mauticform[country1]" value="" class="mauticform-selectbox">
                ...
                <input type="hidden" name="mauticform[formId]" id="mauticform_subscribeformjoinseedsearth_id" value="5">
